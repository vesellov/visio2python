...
I draw it using [this Microsoft Visio stancil](automats.vss).
...
[automat.Automat](automat.py) which runs the state machine.
...
Take the file [**automat.py**](automat.py), 
